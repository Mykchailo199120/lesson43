...
function runOperationsInCtx(operations, ctx) {
    return Promise.all(operations.map(function (operation) { return operation(ctx); }));
}
/**
...
function addFile(filePath, content) {
    ...
    return function (ctx) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    absoluteFilePath = require$$1__namespace.resolve(ctx, filePath);
                    return [4 /*yield*/, lib.createFile(absoluteFilePath)];
                case 1:
                    _a.sent();
                    if (!content) return [3 /*break*/, 5];
                    if (!(typeof content === 'string')) return [3 /*break*/, 3];
                    return [4 /*yield*/, require$$0__namespace.promises.writeFile(absoluteFilePath, content)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, lib.writeJSON(absoluteFilePath, content)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [2 /*return*/, absoluteFilePath];
            }
        });
    }); };
}
...
function addDirectory(dirPath) {
    ...
    return function (ctx) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    nextCtx = require$$1__namespace.resolve(ctx, dirPath);
                    return [4 /*yield*/, lib.mkdirp(nextCtx)["catch"](console.error)];
                case 1:
                    _a.sent();
                    if (!operations) return [3 /*break*/, 3];
                    return [4 /*yield*/, runOperationsInCtx(operations, nextCtx)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3: return [2 /*return*/, nextCtx];
            }
        });
    }); };
}
function createTeardown(baseDir) {
    var operations = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        operations[_i - 1] = arguments[_i];
    }
    var absoluteBaseDir = require$$1__namespace.resolve(process.cwd(), baseDir);
    var api = {
        prepare: function () {
            return runOperationsInCtx(operations, absoluteBaseDir);
        },
        cleanup: function () {
            return lib.remove(absoluteBaseDir);
        },
        getPath: function () {
            var segments = [];
            ...
            return require$$1__namespace.resolve.apply(require$$1__namespace, __spreadArray([absoluteBaseDir], segments));
        },
        editFile: function (filePath, nextContents) {
            var absolutePath = api.getPath(filePath);
            lib.readFileSync(absolutePath);
            lib.writeFileSync(absolutePath, nextContents);
        },
        removeFile: function (filePath) {
            var absolutePath = api.getPath(filePath);
            if (!lib.existsSync(absolutePath)) {
                throw new Error("Failed to remove path: " + absolutePath + ". The given path does not exist.");
            }
            lib.removeSync(absolutePath);
        },
    };
    return api;
}
